...
>[!note]
> C lsp might not work on windows especially. There is a fix for this in the old config but since i don't code in c anymore there is no need to copy the fix right now. Might do later.
